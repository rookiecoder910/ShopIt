...
SEED_PRODUCTS = [
    # ── Fruits & Vegetables ─────────────────────────────────────────
    {"product_id": "prod-1",  "name": "Banana",  "description": "Fresh yellow bananas, rich in potassium",  "price": 40.0,  "category": "Fruits & Vegetables",  "image_url": "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Banana-Single.jpg/250px-Banana-Single.jpg",  "availability": True,  "unit": "1 dozen",  "discount_percent": 10},
